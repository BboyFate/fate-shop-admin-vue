<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="类目" width="220">
        <template slot-scope="{ row }">
          {{ row.category.full_name }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="已上架" width="220">
        <template slot-scope="{ row }">
      ...
      <el-table-column align="center" label="销量" width="220">
        <template slot-scope="{ row }">
          {{ row.sold_count }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="评论数" width="220">
        <template slot-scope="{ row }">
          {{ row.review_count }}
        </template>
      </el-table-column>
